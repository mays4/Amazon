    ...
    <header>
      <div className="flex items-center bg-amazon_blue p-1 flex-grow py-2">
        ...
        <div className='text-white  flex items-center text-sm space-x-6 mx-6 whitespace-nowrap'>
          <div className="link"><p>Hello mays al</p>
          ...
          <div className="relative link flex items-center ">
            ...
            md:right-10 h-5 w-5 bg-yellow-400 text-center rounded-full text-black font-bold'>0</span>
     ...
     pl-6 
      bg-amazon_blue-light text-white text-sm'>
        ...
        <p className=" link hidden lg:inline-flex">Electroics</p>
        <p className=" link hidden lg:inline-flex">Food & grocery</p>
        <p className=" link hidden lg:inline-flex">Prime</p>
        <p className=" link hidden lg:inline-flex">Buy Again</p>
        <p className=" link hidden lg:inline-flex">Shogger Tootkit</p>
